...
<!-- jQuery UI 1.11.4 -->
<script src="<?= base_url() ?>static/bower_components/jquery-ui/jquery-ui.min.js"></script>
...
<!-- Morris.js charts -->
<script src="<?= base_url() ?>static/bower_components/raphael/raphael.min.js"></script>
<script src="<?= base_url() ?>static/bower_components/morris.js/morris.min.js"></script>
<!-- Sparkline -->
<script src="<?= base_url() ?>static/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js"></script>
<!-- jvectormap -->
...
<!-- jQuery Knob Chart -->
<script src="<?= base_url() ?>static/bower_components/jquery-knob/dist/jquery.knob.min.js"></script>
<!-- daterangepicker -->
<script src="<?= base_url() ?>static/bower_components/moment/min/moment.min.js"></script>
<script src="<?= base_url() ?>static/bower_components/bootstrap-daterangepicker/daterangepicker.js"></script>
<!-- datepicker -->
...
<script src="<?= base_url() ?>static/dist/js/myApp.js"></script>
</body>
</html>
